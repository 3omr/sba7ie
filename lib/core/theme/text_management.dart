...
class TextManagement {
  ...
  static TextStyle alexandria12RegularBlack = GoogleFonts.alexandria(
    fontSize: 12.0.sp,
  ...
  static TextStyle alexandria14RegularBlack = GoogleFonts.alexandria(
    fontSize: 14.0.sp,
    fontWeight: FontWeight.w400,
    color: ColorManagement.black,
  );
  ...
  static TextStyle alexandria24BoldBlack = GoogleFonts.alexandria(
    ...
    static TextStyle alexandria22BoldWhite = GoogleFonts.alexandria(
    fontSize: 22.0.sp,
    fontWeight: FontWeight.w700,
    color: ColorManagement.white,
  );
