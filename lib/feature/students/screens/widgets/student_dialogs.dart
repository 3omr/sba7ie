...
class StudentDialogs {
  static void showAddNewSubscriptionDialogYearly(
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                AppSnackBars.showSuccessSnackBar(
                    context: context, successMsg: 'تمت إضافة الدفعة بنجاح');
                Navigator.of(context).pop();
              },
              child:
  ...
  static void showAddNewSubscriptionDialogYearlyMonthly(
      {required BuildContext context,
      required StudentSubscriptionCubit studentSubscriptionCubit}) {
    showDialog(
      context: context,
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await studentSubscriptionCubit
                  ...
                  idStudent: studentSubscriptionCubit.student.id,
                  money: int.tryParse(amountController.text) ?? 0,
                  date: DateHelper.getFormattedCurrentDate(currentDate),
                ));
                AppSnackBars.showSuccessSnackBar(
                    context: context, successMsg: 'تمت إضافة الدفعة بنجاح');
                Navigator.of(context).pop();
